...
| Order pizza                                         |menu.tsx <br> payment.tsx <br> delivery.tsx | [GET] /api/order/menu <br> [GET] api/franchise?page=0&limit=20& name=*<br> [POST] /api/order                |`SELECT * FROM menu`<br>              |
